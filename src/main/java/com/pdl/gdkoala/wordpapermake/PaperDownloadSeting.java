...
public class PaperDownloadSeting {
     ...
     * @Desc: 下载文档总方法入口
     */
    public static void createWord(Map<String, Object> paperMap, OutputStream out) throws Exception {
        //将试卷内容转换为word格式
        paperMap = QuestionDataFormat.htmlPaperToWordStyle(paperMap);
        logger.info("将试卷内容转换为word格式paperMap==" + JsonUtil.toJson(paperMap));
    ...
    public static void zipdocx(Map<String, Object> paperMap, ZipOutputStream zipout) throws IOException, TemplateException, URISyntaxException {
        ...
        Writer w = new OutputStreamWriter(zipout, StandardCharsets.UTF_8);
        File file = makeDirs();
        ...
        logger.info(" =========tempMediaPath img file is " + tempMediaPath);
        ...
        if (tempMediaPath != null && tempMediaPath != "" && imagesFile.exists()) {
            ...
            if (imagesList.length > 0) {
                for (File tmpFile : imagesList) {
                    ...
                    //for test.....
                    //tmpFile.delete();
                    logger.info(" =========temp img file is " + tmpFile.getAbsolutePath());
                }
            }
        }
...
//        String filePath = "/E:/work/java-eclipse(mars2)/workspace-gdkoala/paperdownload/paper_download-master/paper_download-master/target/tempfile/";
//        String filePath = File.separator + "data" + File.separator + "gdkoala" + File.separator + "tutorial" + File.separator + "paperdownload" + File.separator + "tempfile" + File.separator;
    ...
    public static void deleteTmpImages(String floderPath) {
        ...
        if (floderPath == null || floderPath.equals("") || !imagesFloder.exists()) {
            return;
        }
